...
const STREAMING_ICON_DOTS = [1, 2];

export const SkeletonLoader = React.memo(() => (
  <div className="animate-pulse relative z-10 min-h-screen bg-transparent flex flex-col text-white overflow-hidden">
    {/* Nav */}
